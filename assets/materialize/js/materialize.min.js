...
function toast(a, b, c, d) {
  ...
  var f = $("#toast-container"),
    g = e(a);
  f.append(g),
    g.css({ top: parseFloat(g.css("top")) + 35 + "px", opacity: 0 }),
    g.velocity(
      { top: "0px", opacity: 1 },
  ...
  var h = b,
    i = setInterval(function () {
      0 === g.parent().length && window.clearInterval(i),
        g.hasClass("panning") || (h -= 100),
        0 >= h &&
          (g.velocity(
  ...
  (function (a) {
    ...
    return (function (a, b, c, d) {
      ...
      function k(a) {
        if (a)
          for (
            var b = new Date().getTime(), c = 0, e = t.State.calls.length;
            e > c;
            c++
          )
            if (t.State.calls[c]) {
              ...
              for (
                var o = Math.min((b - j) / i.duration, 1), q = 0, r = h.length;
                r > q;
                q++
              ) {
                var s = h[q],
                ...
                if (g(u)) {
                  ...
                  i.visibility !== d &&
                    "hidden" !== i.visibility &&
                    v.setPropertyValue(u, "visibility", i.visibility);
                  for (var z in s)
                    if ("element" !== z) {
                      var A,
                        B = s[z],
                        C = p.isString(B.easing)
                          ? t.Easings[B.easing]
                          : B.easing;
                      if (1 === o) A = B.endValue;
                      else if (
                        ((A =
                          B.startValue + (B.endValue - B.startValue) * C(o)),
                        !n && A === B.currentValue)
                      )
                        continue;
                      ...
                      var F = v.setPropertyValue(
                        u,
                        z,
                        B.currentValue +
                          (0 === parseFloat(A) ? "" : B.unitType),
                        B.rootPropertyValue,
                        B.scrollData
                      );
                      v.Hooks.registered[z] &&
                        (g(u).rootPropertyValueCache[D] = v.Normalizations
                          .registered[D]
                          ? v.Normalizations.registered[D](
                              "extract",
                              null,
                              F[1]
                            )
                  ...
                  i.mobileHA &&
                    g(u).transformCache.translate3d === d &&
                    ((g(u).transformCache.translate3d = "(0px, 0px, 0px)"),
                    (w = !0)),
                    w && v.flushTransformCache(u);
                }
              }
              i.display !== d &&
                "none" !== i.display &&
                (t.State.calls[c][2].display = !1),
                i.visibility !== d &&
                  "hidden" !== i.visibility &&
                  (t.State.calls[c][2].visibility = !1),
                i.progress &&
                  i.progress.call(
                    f[1],
                    f[1],
                    o,
                    Math.max(0, j + i.duration - b),
                    j
                  ),
                1 === o && l(c);
            }
            ...
            /^[\d-]/.test(i) ||
              (i =
                g(a) && g(a).isSVG && v.Names.SVGAttribute(c)
                  ? /^(height|width)$/i.test(c)
                    ? a.getBBox()[c]
                    : a.getAttribute(c)
                  : h(a, v.Names.prefixCheck(c)[0])),
      ...
      var w = function () {
        ...
        function h() {
          function a() {
                  ...
                  ? ((c = a[0]),
                    ...
                    v.RegEx.isHex.test(a[1])
                      ...
                      : ((p.isString(a[1]) && !v.RegEx.isHex.test(a[1])) ||
                          p.isArray(a[1])) &&
                        ((e = b ? a[1] : j(a[1], i.duration)),
                        a[2] !== d && (f = a[2])))
                  : (c = a),
                b || (e = e || i.easing),
                p.isFunction(c) && (c = c.call(h, z, y)),
                p.isFunction(f) && (f = f.call(h, z, y)),
                [c || 0, e, f]
              );
            }
            function n(a, b) {
            ...
            function o() {
              var a = {
                ...
                d =
                  a.position === J.lastPosition && a.myParent === J.lastParent,
                e = a.fontSize === J.lastFontSize;
              (J.lastParent = a.myParent),
                (J.lastPosition = a.position),
                (J.lastFontSize = a.fontSize);
              var f = 100,
                i = {};
              if (e && d)
                (i.emToPx = J.lastEmToPx),
                  (i.percentToPxWidth = J.lastPercentToPxWidth),
                  (i.percentToPxHeight = J.lastPercentToPxHeight);
              else {
                var j = g(h).isSVG
                ...
                t.init(j),
                  ...
                  t.CSS.setPropertyValue(j, "paddingLeft", f + "em"),
                  (i.percentToPxWidth = J.lastPercentToPxWidth =
              ...
              return (
                ...
                null === J.vwToPx &&
                  ((J.vwToPx = parseFloat(b.innerWidth) / 100),
                  (J.vhToPx = parseFloat(b.innerHeight) / 100)),
                (i.remToPx = J.remToPx),
                (i.vwToPx = J.vwToPx),
                (i.vhToPx = J.vhToPx),
                t.debug >= 1 &&
                  console.log("Unit ratios: " + JSON.stringify(i), h),
                i
              );
            }
            if (i.begin && 0 === z)
            ...
            if ("scroll" === D) {
              ...
              i.container
                ? p.isWrapped(i.container) || p.isNode(i.container)
                  ? ((i.container = i.container[0] || i.container),
                    ...
                    (A = w + m(h).position()[B.toLowerCase()] + E))
                  : (i.container = null)
                ...
                t.debug &&
                  console.log("tweensContainer (scroll): ", l.scroll, h);
            } else if ("reverse" === D) {
              if (!g(h).tweensContainer) return void m.dequeue(h, i.queue);
              "none" === g(h).opts.display && (g(h).opts.display = "auto"),
                "hidden" === g(h).opts.visibility &&
                  (g(h).opts.visibility = "visible"),
                (g(h).opts.loop = !1),
                (g(h).opts.begin = null),
                (g(h).opts.complete = null),
                u.easing || delete i.easing,
                u.duration || delete i.duration,
                (i = m.extend({}, g(h).opts, i));
              ...
              for (var G in F)
                if ("element" !== G) {
                  ...
                  (F[G].startValue = F[G].currentValue = F[G].endValue),
                    (F[G].endValue = H),
                    p.isEmptyObject(u) || (F[G].easing = i.easing),
                    t.debug &&
                      console.log(
              ...
              g(h).tweensContainer &&
                g(h).isAnimating === !0 &&
                (F = g(h).tweensContainer),
                m.each(s, function (b, c) {
              ...
              for (var I in s) {
                ...
                if (
                  ...
                  ((i.display !== d &&
                    ...
                    0 !== M &&
                    (O = 0),
                    i._cacheValues && F && F[I]
                      ? (O === d && (O = F[I].endValue + F[I].unitType),
                        (Q = g(h).rootPropertyValueCache[P]))
                      : v.Hooks.registered[I]
                      ? O === d
                        ? ((Q = v.getPropertyValue(h, P)),
                          (O = v.getPropertyValue(h, I, Q)))
                        : (Q = v.Hooks.templates[P][1])
                      : O === d && (O = v.getPropertyValue(h, I));
                  var R,
                    S,
                    T,
                    U = !1;
                  ...
                  (l[I] = {
                    ...
                    t.debug &&
                      console.log(
                        "tweensContainer (" + I + "): " + JSON.stringify(l[I]),
                        h
                      );
                } else
                  t.debug &&
            ...
            l.element &&
              (v.Values.addClass(h, "velocity-animating"),
              K.push(l),
              "" === i.queue && ((g(h).tweensContainer = l), (g(h).opts = i)),
              (g(h).isAnimating = !0),
              z === y - 1
                ? (t.State.calls.length > 1e4 &&
                    (t.State.calls = e(t.State.calls)),
                  t.State.calls.push([K, q, i, null, C.resolver]),
          ...
          t.mock !== !1 &&
            ...
            i.display !== d &&
              ...
              "auto" === i.display &&
                (i.display = t.CSS.Values.getDisplayType(h))),
            i.visibility !== d &&
              null !== i.visibility &&
            ...
            i.queue === !1
              ? i.delay
                ? setTimeout(a, i.delay)
                : a()
              : m.queue(h, i.queue, function (b, c) {
                  return c === !0
                    ? (C.promise && C.resolver(q), !0)
                    : ((t.velocityQueueEntryFlag = !0), void a(b));
                }),
            ("" !== i.queue && "fx" !== i.queue) ||
              "inprogress" === m.queue(h)[0] ||
              m.dequeue(h);
        }
        var i,
          n,
        ...
        if (
          (p.isWrapped(this)
            ...
            : ((i = !0),
              (o = 1),
              (q = x ? arguments[0].elements : arguments[0])),
          (q = f(q)))
        ) {
          x
            ? ((s = arguments[0].properties), (u = arguments[0].options))
                ...
                m.each(t.State.calls, function (a, b) {
                  b &&
                    m.each(b[1], function (c, e) {
                      ...
                      return u !== d && b[2].queue !== f
                        ? !0
                        : void m.each(q, function (b, c) {
                            c === e &&
                              (u !== d &&
                                (m.each(m.queue(c, f), function (a, b) {
                                  p.isFunction(b) && b(null, !0);
                                }),
                                m.queue(c, f, [])),
                              g(c) &&
                                "" === f &&
                                m.each(g(c).tweensContainer, function (a, b) {
              ...
              if (!m.isPlainObject(s) || p.isEmptyObject(s)) {
                if (p.isString(s) && t.Redirects[s]) {
                  var F = m.extend({}, u),
                    ...
                    H = F.delay || 0;
                  return (
                    F.backwards === !0 && (q = m.extend(!0, [], q).reverse()),
                    m.each(q, function (a, b) {
                      parseFloat(F.stagger)
                        ? (F.delay = H + parseFloat(F.stagger) * a)
                        : p.isFunction(F.stagger) &&
                          (F.delay = H + F.stagger.call(b, a, y)),
                        F.drag &&
                          ((F.duration =
                            parseFloat(G) ||
                ...
                return (
                  C.promise ? C.rejecter(new Error(I)) : console.log(I), a()
                );
              }
              D = "start";
          }
        ...
        this.each(function () {
          function c(a) {
            (f = e.find(".collapsible-header")),
              ...
              f.not(a).parent().removeClass("active"),
              f
                .not(a)
                .parent()
          ...
          e.off(),
            e.children().off(),
            b.accordion || "accordion" == g || void 0 == g
              ? (e.on("click", ".collapsible-header", function (b) {
                  c(a(b.currentTarget));
                }),
                c(f.filter(".active").first()))
              : f.each(function () {
                  e.on("click", ".collapsible-header", function (b) {
                    d(a(b.currentTarget));
                  }),
        ...
        this.each(function () {
          function c() {
            void 0 != f.data("inDuration") &&
              (b.inDuration = f.data("inDuration")),
              void 0 != f.data("outDuration") &&
                (b.outDuration = f.data("outDuration")),
              void 0 != f.data("constrainwidth") &&
                (b.constrain_width = f.data("constrainwidth")),
              void 0 != f.data("hover") && (b.hover = f.data("hover")),
              void 0 != f.data("alignment") &&
                (b.alignment = f.data("alignment")),
              void 0 != f.data("gutter") && (b.gutter = f.data("gutter"));
          }
          function d() {
            c();
            var d = g.height();
            ...
            var h = 0,
              i = b.gutter;
            "right" == b.alignment &&
              ((h = f.innerWidth() - g.innerWidth()), (i = -1 * i)),
              g.css(
                e(f[0])
                  ? {
                      display: "block",
              ...
              g
                .velocity(
                  { opacity: 1 },
                  { duration: b.inDuration, queue: !1, easing: "easeOutQuad" }
                )
                .velocity(
                  { height: d },
                  {
          ...
          if (
            (c(),
            g.parent().is(a("body")) || (g.detach(), a("body").append(g)),
            b.hover)
          )
            ...
            f.click(function (c) {
              c.preventDefault(),
                c.stopPropagation(),
                d(),
                a(document).bind("click." + g.attr("id"), function (c) {
                  g.is(c.target) ||
                    f.is(c.target) ||
                    (g.velocity(
                      { opacity: 0 },
    ...
    a.fn.extend({
      openModal: function (b) {
        ...
        (b = a.extend(e, b)),
          ...
          a(c).css({ display: "block", top: "4%", opacity: 0 }),
          a("#lean-overlay").velocity(
            { opacity: b.opacity },
            { duration: b.in_duration, queue: !1, ease: "easeOutCubic" }
          ),
          a(c).velocity(
            { top: "10%", opacity: 1 },
            {
      ...
      a.fn.extend({
        closeModal: function (b) {
          var c = { out_duration: 200, complete: void 0 },
            b = a.extend(c, b);
          a("#lean-overlay").velocity(
            { opacity: 0 },
            { duration: b.out_duration, queue: !1, ease: "easeOutQuart" }
          ),
            a(this).fadeOut(b.out_duration, function () {
              a(this).css({ top: 0 }),
                a("#lean-overlay").css({ display: "none" }),
                "function" == typeof b.complete && b.complete(),
                a("#lean-overlay").remove();
            });
        },
      }),
      a.fn.extend({
        ...
        function c(c) {
          ...
          h > j &&
            ...
            d
              ...
              .first()
              .css("bottom", n + "px"),
            c && d.children("img").first().css("display", "block");
        }
        var d = a(this);
        d.addClass("parallax"),
          c(!0),
        ...
        (b = a.extend(c, b)),
          a(this).each(function () {
            ...
            var d = a(this),
              ...
              f = 240;
            "left" != b.edge && e.addClass("right-aligned"),
              a("body").append(a('<div class="drag-target"></div>')),
              a(".drag-target").css(
                "left" === b.edge ? { left: 0 } : { right: 0 }
              ),
              e.hasClass("fixed") &&
                a(window).resize(function () {
                  a(window).width() > 1200 &&
                    e.attr("style") &&
                    e.removeAttr("style"),
                    0 != a("#sidenav-overlay").css("opacity") &&
                      h &&
                  ...
                  if (
                    ...
                    "left" === b.edge
                      ? f / 2 > g
                        ? (h = !1)
                        : g >= f / 2 && (h = !0)
                      : g < a(window).width() - f / 2
                      ? (h = !0)
                      : g >= a(window).width() - f / 2 && (h = !1),
                    "left" === b.edge
                      ? e.css("left", g - f)
                      : e.css("right", -1 * (g - f / 2)),
                    "left" === b.edge)
    ...
    a(document).ready(function () {
      ...
      if (
        ...
        a(document).on("reset", function (c) {
          a(c.target).is("form") &&
            (a(this).find(b).removeClass("valid").removeClass("invalid"),
            a(this)
        ...
        a(document).on("blur", b, function () {
          0 === a(this).val().length
            ? (a(this).siblings("label, i").removeClass("active"),
              a(this).hasClass("validate") &&
                (a(this).removeClass("valid"), a(this).removeClass("invalid")))
            : a(this).hasClass("validate") &&
              (a(this).is(":valid")
                ? (a(this).removeClass("invalid"), a(this).addClass("valid"))
                : (a(this).removeClass("valid"), a(this).addClass("invalid")));
        }),
      ...
      a(".hiddendiv").css("width", a(e).width()),
        a(e).each(function () {
          a(this).val().length &&
            ((d = a(this).val()),
            (d = d.replace(/\n/g, "<br>")),
      ...
      a(document).on("mousedown", h, function (b) {
        ...
        0 > d ? (d = 0) : d > e && (d = e),
          ...
          c.find(".value").html(a(this).children("input[type=range]").val());
      }),
        ...
        a(document).on("mousemove", h, function (b) {
          ...
          if (g) {
            ...
            0 > d ? (d = 0) : d > e && (d = e),
              ...
              c
                .find(".value")
                .html(a(this).children("input[type=range]").val());
          }
        }),
          ...
          a(this).each(function () {
            if (
              ...
              if (void 0 !== $select.find("option:selected"))
                var g = $select.find("option:selected");
              else var g = e.first();
              f.each(function () {
                e.append(
                  a(
                ...
                e.find("li").each(function (c) {
                  ...
                  a(this).click(function () {
                    a(this).hasClass("disabled") ||
                      ...
                      d.trigger("change"),
                      d.prev("span.select-dropdown").html(a(this).text()),
              ...
              $select.before(h),
                a("body").append(e),
                $select.is(":disabled") || h.dropdown({ hover: !1 }),
            ...
            h.find("img").each(function () {
              a(this).load(function () {
                a(this).width() < a(this).parent().width() &&
                  a(this).css({ width: "100%", height: "auto" });
              });
            }),
            b.indicators)
          ) {
